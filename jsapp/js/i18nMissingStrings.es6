...
test = t("This question could not be imported. Please re-create it manually. Please contact us  so we can fix this bug!");
test = t("Add Question");
test = t("or");
test = t("Import XLS");
...
test= t("Note: Rank and Matrix question types are currently in beta.");
